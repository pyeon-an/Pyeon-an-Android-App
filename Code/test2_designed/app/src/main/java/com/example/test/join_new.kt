...
//        var password: String = et_password.text.toString()
        ...
        // 애니매이션 추가
        val email_ttb = AnimationUtils.loadAnimation(this, R.anim.email_ttb)
        val passwd_ttb = AnimationUtils.loadAnimation(this, R.anim.passwd_ttb)
        val passwd2_ttb = AnimationUtils.loadAnimation(this, R.anim.passwd2_ttb)
        val date_ttb = AnimationUtils.loadAnimation(this, R.anim.date_ttb)
        val nickname_ttb = AnimationUtils.loadAnimation(this, R.anim.nickname_ttb)
        val join_btt = AnimationUtils.loadAnimation(this, R.anim.join_btt)
        val join_btt2 = AnimationUtils.loadAnimation(this, R.anim.join_btt2)
        val phone_ttb = AnimationUtils.loadAnimation(this, R.anim.phone_ttb)
        ...
        check_email.startAnimation(join_btt)
        join.startAnimation(join_btt2)

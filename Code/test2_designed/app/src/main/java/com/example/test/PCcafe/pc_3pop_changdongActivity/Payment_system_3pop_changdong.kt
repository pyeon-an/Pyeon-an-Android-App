...
class Payment_system_3pop_changdong : Service() {
    ...
    override fun onCreate() {
        ...
        val myRef : DatabaseReference = database.getReference("PCcafe").child("3POP").child("창동")
    }
                        ...
                        timerTask = timer(period = 3000) {
                            if (point <= 1) {
                                val pcRef: DatabaseReference =
                                    database.getReference("PCcafe").child("3POP").child("창동")
    ...
    override fun onDestroy() {
        ...
        val database : FirebaseDatabase = FirebaseDatabase.getInstance()
        val myRef : DatabaseReference = database.getReference("owner").child("3POP창동").child("income")
    ...
    private fun createNotification() {
       ...
       // builder.setSmallIcon(R.mipmap.ic_launcher)
        ...
        builder.setContentText("PC cafe : 3POP(창동)")

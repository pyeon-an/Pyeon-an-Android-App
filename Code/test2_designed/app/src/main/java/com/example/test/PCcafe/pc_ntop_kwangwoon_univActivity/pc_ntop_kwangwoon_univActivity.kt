...
class pc_ntop_kwangwoon_univActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myRef1 : DatabaseReference = database.getReference("PCcafe").child("NTop").child("광운대").child("1")
        val myRef2 : DatabaseReference = database.getReference("PCcafe").child("NTop").child("광운대").child("2")
        val myRef3 : DatabaseReference = database.getReference("PCcafe").child("NTop").child("광운대").child("3")
        val myRef4 : DatabaseReference = database.getReference("PCcafe").child("NTop").child("광운대").child("4")

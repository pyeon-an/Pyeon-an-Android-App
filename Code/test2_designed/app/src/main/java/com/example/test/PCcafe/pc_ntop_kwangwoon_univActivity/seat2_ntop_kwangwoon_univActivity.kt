...
class seat2_ntop_kwangwoon_univActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myRef : DatabaseReference = database.getReference("PCcafe").child("NTop").child("광운대").child("2")
        var check=0
                ...
                myRef.child("using").addValueEventListener(object : ValueEventListener {
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        ...
                        if (value!!.equals("X") && check == 0 && user == 1) {
                            ...
                            memberRef.child(auth.currentUser?.uid.toString()).child("seat_using").setValue("2")

...
class seat1_ntop_kwangwoon_univActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myRef : DatabaseReference = database.getReference("PCcafe").child("NTop").child("광운대").child("1")
        var check=0

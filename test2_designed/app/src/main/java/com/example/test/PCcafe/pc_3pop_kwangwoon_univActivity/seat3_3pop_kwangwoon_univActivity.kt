...
class seat3_3pop_kwangwoon_univActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myRef : DatabaseReference = database.getReference("PCcafe").child("3POP").child("광운대").child("3")
        var check=0

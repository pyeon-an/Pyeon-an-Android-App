...
class seat3_3pop_changdongActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myRef : DatabaseReference = database.getReference("PCcafe").child("3POP").child("창동").child("3")
        var check=0
